...
const Projects_Page = () => {
    ...
    const projects = [
        ...
        },
        {
            ...
            description: "For this project, I used React and a little bit of nodejs to build this website! I've been wanting to really learn webdev technologies and build a portfolio for myself for a while so I was really excited to get this project finished. Although I marked this project as finished, I am constantly updated the project and like several of these, will never really finishing tweaking to make it perfect. I did not have a strong need for a backend on this site so most of the site is just the frontend. I toyed with the idea of setting up a database for this site but decided that it wasn't really necessary and I could do that on a later project anyway. Also, I don't think React was strictly necessary for this project as it isn't too large but its always nice to learn technologies and see the differences between basic html, css, and js vs what these projects can provide. I was also planning on using tailwind CSS for this project but decided to focus strictly on react for now.",
